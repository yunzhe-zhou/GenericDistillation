...
string = "symbolic_data2" + "_n_sim_" + str(args0.n_sim) + "_nmax_" + str(args0.nmax) + "_len_max_" + str(args0.len_max)
...
for seed in tqdm(range(100)):
    rule_str0, rule_str, n, group_step, rule_fit0,rule_fit, loss_best = model_select(seed,X,F_funct,x_gen_normal,loss_cross,num_sim=args0.n_sim
