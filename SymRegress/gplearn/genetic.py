...
def _parallel_evolve(n_programs, parents, X, y, sample_weight, seeds, params,max_depth):
    ...
    while len(programs) <= n_programs:
        ...
        if program._depth() > max_depth:
            continue
        # if program._length() > max_depth:
        #     continue
...
class BaseSymbolic(BaseEstimator, metaclass=ABCMeta):
    ...
    def fit(self, X, y,max_depth, sample_weight=None):
